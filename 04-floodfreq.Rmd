...
increases. Vice versa, if correlation increases, $\theta$ increases, too. 
...
Thus, we expect them to outperform FNACs given the observed data strucutre. To confirm this, we 
compared FNACs and vines using a simulation and drew conclusions on the behavior of FNACs in a vine setting. 
