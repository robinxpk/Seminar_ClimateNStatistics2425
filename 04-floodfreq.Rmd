...
```{r corplot, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width = "100%", fig.cap="The Kendalls au Coefficients for the three dependency structures of volume, duration and peak for the Isar and the Danube. Black dots mark the respective results found in @grimaldi2006."}
